        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6><?php echo app('translator')->get('lang.food'); ?></h6>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <a style="float:right;padding-right:30px;" class="text-light">
                            <button class=" btn btn-primary float-right mb-3" data-bs-toggle="modal" data-bs-target="#food"><?php echo app('translator')->get('lang.add'); ?>
                            </button>
                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <?php if(strstr($value->image,"https") === false): ?>
                                            <img class="img-fluid rounded-start img_movie" style="height: 200px" src="https://res.cloudinary.com/<?php echo $cloud_name; ?>/image/upload/<?php echo e($value->image); ?>.jpg" alt="">
                                        <?php else: ?>
                                            <img class="img-fluid rounded-start" style="height: 200px" src="<?php echo e($value->image); ?>" alt="">
                                        <?php endif; ?>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold"><?php echo number_format($value['price']); ?></span>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <a href="#editFood" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                           data-original-title="Edit director" data-bs-target="#editFood<?php echo $value['id']; ?>"
                                           data-bs-toggle="modal">
                                            <i class="fa-solid fa-pen-to-square fa-lg"></i>
                                        </a>
                                    </td>
                                    <td class="align-middle">
                                        <a href="javascript:void(0)" data-url="<?php echo e(url('admin/food/delete', $value['id'] )); ?>"
                                           class="text-secondary font-weight-bold text-xs delete-food" data-toggle="tooltip">
                                            <i class="fa-solid fa-trash-can fa-lg"></i>
                                        </a>
                                    </td>
                                </tr>
                                <?php echo $__env->make('admin.web.Food.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('admin.web.Food.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/admin/web/Food/index.blade.php ENDPATH**/ ?>