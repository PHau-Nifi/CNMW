                ...
                <form method="post" action="/admin/movie/create" enctype="multipart/form-data">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0"><?php echo app('translator')->get('lang.movies'); ?></p>
                            <button type="submit" class="btn bg-gradient-primary btn-sm ms-auto"><?php echo app('translator')->get('lang.confirm'); ?></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <h5 class="text-uppercase text-sm"><?php echo app('translator')->get('lang.add'); ?></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="showTime"><?php echo app('translator')->get('lang.showtime'); ?></label>
                                    <input id="showTime" class="form-control" name="showTime" placeholder="<?php echo app('translator')->get('lang.showtime'); ?>"
                                           type="number" value="">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="national"><?php echo app('translator')->get('lang.national'); ?></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="movieGenres"><?php echo app('translator')->get('lang.genre'); ?></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="director"><?php echo app('translator')->get('lang.directors'); ?></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="releaseDate"  id="releaseDate" class="form-control datepicker" placeholder="<?php echo app('translator')->get('lang.date'); ?>" type="text">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="endDate"><?php echo app('translator')->get('lang.end_date'); ?></label>
                                    <input id="endDate" name="endDate" class="form-control datepicker" placeholder="<?php echo app('translator')->get('lang.date'); ?>" type="text">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="rating"><?php echo app('translator')->get('lang.rating'); ?></label>
                                    <select id="rating" class="form-select" name="rating">
                                        <?php $__currentLoopData = $rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" class="fw-bold"
                                                    title="<?php echo e($item->description); ?>"><?php echo e($item->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="casts"><?php echo app('translator')->get('lang.casts'); ?></label>
                                    <input type="text" id="casts" class="form-control cast-input" name="cast">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group file-uploader">
                                    <label for="movieImage"><?php echo app('translator')->get('lang.image'); ?></label>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/admin/web/movies/create.blade.php ENDPATH**/ ?>