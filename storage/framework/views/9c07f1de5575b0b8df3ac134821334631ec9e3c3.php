                ...
                <div class="modal-body my-4">
                    <form method='post' action="/forgot_password">
                        ...
                        <div class="modal-footer justify-content-center text-center">
                            <button type='submit' class="btn btn-primary text-uppercase"><?php echo app('translator')->get('lang.submit'); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/web/auth/login.blade.php ENDPATH**/ ?>