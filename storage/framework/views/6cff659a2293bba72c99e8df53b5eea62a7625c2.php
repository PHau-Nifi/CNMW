            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6><?php echo app('translator')->get('lang.staff'); ?></h6>
                    </div>
                            ...
                            <table class="table align-items-center mb-0 ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><?php echo app('translator')->get('lang.theater'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary font-weight-bold"> <?php echo e($value->role->name); ?></span>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary font-weight-bold"><span class="text-secondary font-weight-bold">
                                                <?php if($value->theater): ?>
                                                    <?php echo e($value->theater->name); ?>
                                        ...
                                        <td class="align-middle">
                                           ...
                                           data-original-title="Edit director" data-bs-target="#editStaff<?php echo $value['id']; ?>"
                                           data-bs-toggle="modal">
                                            <i class="fa-solid fa-pen-to-square fa-lg"></i>
                                        </a>
                                        </td>
                                        <td class="align-middle">
                                            <a href="javascript:void(0)" data-url="<?php echo e(url('admin/staff/delete', $value['id'] )); ?>" class="text-secondary font-weight-bold text-xs delete-staff" data-toggle="tooltip" data-original-title="Edit user">
                                                <i class="fa-solid fa-trash-can fa-lg"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php echo $__env->make('admin.web.Staffs.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('admin.web.Staffs.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                               
                                </tbody>
                            </table>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/admin/web/Staffs/index.blade.php ENDPATH**/ ?>