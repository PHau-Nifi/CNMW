                        ...
                        <div id="ticket_info" class="card mb-3 bg-dark text-light px-0 sticky-top">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-9 col-lg-12">
                                    <div class="card-body">
                                        <h5 class="card-title text-light"><?php echo e($movie->name); ?></h5>
                                        <ul class="list-group">
                                                                ...
                                                                <li class="list-group-item border-0">
                                                                    <div class="d-flex">
                                                                        <div class="d-inline-block me-2"
                                                                             style="width: 24px; height: 24px; background-color: <?php echo e($seatType->color); ?>">
                                                                        </div>
                                                                        <?php echo e(number_format($seatType->surcharge+$price+$room->roomType->surcharge)); ?> đ
                                                                    </div>
                                                                </li>
                                            ...
                                            <div class="card px-0 overflow-hidden" id="Combo_<?php echo e($combo->id); ?>"
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-lg-4 col-12">
                                                        <img class="img-fluid w-100" alt="..." style="max-height: 361px; max-width: 241px" <?php if(strstr($combo->image,"https") === false): ?>
            ...
            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $ticket->ticketSeats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketSeat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($seat->id == $ticketSeat->seat_id): ?>
                        console.log(1)
                        $('#Seats').find('#Seat_<?php echo e($seat->id); ?>').replaceWith(`<div class="d-inline-block mx-1 align-middle py-1 px-0  text-dark disabled" choice="1" style="background-color: #c3c3c3; width: 30px; height: 30px; line-height: 22px; font-size: 10px; margin: 2px 0;">
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/admin/web/buyTicket/ticket.blade.php ENDPATH**/ ?>