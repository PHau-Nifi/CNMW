            ...
            <div class="product-list col-10">
                <h5 class="mb-3"> 
                    ...
                    <?php else: ?>
                        ...
                        <?php endif; ?>
                        <?php if($rate!=NULL): ?> 
                            | Xếp hạng: <?php echo e($rate->name); ?> (<?php echo e($rate->description); ?>)
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="row">
                    <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="item">
                               <a class="thumb" href="/movie/<?php echo e($movie->id); ?>" title="<?php echo $movie['name']; ?>">
                                <figure><img class="lazy img-responsive" 
                                    ...
                                    <?php endif; ?> 
                                    alt="" title="<?php echo $movie['name']; ?>" style="height: 350px"></figure>
                                <span class="status
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LVTN\QLRapPhim\resources\views/web/search.blade.php ENDPATH**/ ?>