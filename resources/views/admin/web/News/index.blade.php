                        ...
                        <table class="table align-items-center mb-0 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        {{-- <img style="width: 300px" src="images/news/{!! $value['image'] !!}" alt="user1"> --}}
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold">{!! date('d/m/Y', strtotime($value['created_at'])) !!}</span>
                                    </td>
                                    <td class="align-middle text-center">
                                        <span class="text-secondary font-weight-bold">{!! date('d/m/Y', strtotime($value['updated_at'])) !!}</span>
                                    </td>
                                ...
                                @include('admin.web.news.edit')
                                @endforeach
                                @include('admin.web.news.create')
                            </tbody>
                        </table>
                    </div>
