                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 food_group">
                                <span class="form-label">@lang('lang.food')</span>
                                <div class="input-group m-1">
                                    <span class="input-group-text text-black-50">@lang('lang.detail'): </span>
                                    ...
                                    <input type="number" name="quantity[]" class="form-control" placeholder="@lang('lang.quantity')" aria-label="quantity">
                                    <button type="button" class="btn btn-danger mb-0 delete_food"><i class="fa-solid fa-trash"></i></button>
                                </div>
                            </div>
                            <button type="button" class="btn m-1 btn-primary add_food">@lang('lang.add')</button>
                        </div>
                    </div>
                </div>
