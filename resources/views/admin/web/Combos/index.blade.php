...
<div class="container-fluid py-4">
                    ...
                    <div class="table-responsive p-0">
                        <a style="float:right;padding-right:30px;" class="text-light">
                            <button class=" btn btn-primary float-right mb-3" data-bs-toggle="modal"
                                    data-bs-target="#combo">@lang('lang.add')
                            </button>
                        </a>
                        <table class="table align-items-center mb-0 ">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">@lang('lang.detail')</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        @if(strstr($combo->image,"https") === false)
                                            <img class="img-fluid rounded-start" style="height: 200px" src="https://res.cloudinary.com/{!! $cloud_name !!}/image/upload/{{ $combo->image }}.jpg" alt="">
                                        @else
                                            <img class="img-fluid rounded-start" style="height: 200px" src="{{ $combo->image }}" alt="">
                                        @endif
                                    </td>
                                    <td class="align-middle text-center">
    ...
    @include('admin.web.Combos.create')
    </div>
@endsection
@section('js')
    <script>
