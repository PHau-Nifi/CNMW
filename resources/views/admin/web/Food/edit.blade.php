                            ...
                            <div class="col-md-12">
                                <div class="form-group file-uploader">
                                    ...
                                    @if(strstr($value->image,"https") === false)
                                        <img class="img-fluid rounded-start img_food" style="height: 200px" src="https://res.cloudinary.com/{!! $cloud_name !!}/image/upload/{{ $value->image }}.jpg" alt="">
                                    @else
                                        <img class="img-fluid rounded-start img_food" style="height: 200px" src="{{ $value->image }}" alt="">
                                    @endif
                                </div>
                            </div>
                        </div>
