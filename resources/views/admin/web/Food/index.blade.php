                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <a style="float:right;padding-right:30px;" class="text-light">
                            <button class=" btn btn-primary float-right mb-3" data-bs-toggle="modal" data-bs-target="#food">@lang('lang.add')
                            </button>
                        </a>
                        <table class="table align-items-center mb-0 ">
                            ...
                            @foreach($food as $value)
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        @if(strstr($value->image,"https") === false)
                                            <img class="img-fluid rounded-start img_movie" style="height: 200px" src="https://res.cloudinary.com/{!! $cloud_name !!}/image/upload/{{ $value->image }}.jpg" alt="">
                                        @else
                                            <img class="img-fluid rounded-start" style="height: 200px" src="{{ $value->image }}" alt="">
                                        @endif
                                    </td>
                                    <td class="align-middle text-center">
                                ...
                                @include('admin.web.Food.edit')
                            @endforeach
                            @include('admin.web.Food.create')
                            </tbody>
                        </table>
                    </div>
