                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <a style="float:right;padding-right:30px;" class="text-light">
                                <button class=" btn btn-primary float-right mb-3" data-bs-toggle="modal" data-bs-target="#banner">@lang('lang.add')</button>
                            </a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if(strstr($value->image,"https") === false)
                                            <img class="img-fluid rounded-start" style="width: 300px" src="https://res.cloudinary.com/{!! $cloud_name !!}/image/upload/{{ $value->image }}.jpg" alt="">
                                        @else
                                            <img class="img-fluid rounded-start" style="width: 300px" src="{{ $value->image }}" alt="">
                                        @endif
                                        </td>
                                        ...
                                        @include('admin.web.Banners.edit')
                                    @endforeach
                                        @include('admin.web.Banners.create')
