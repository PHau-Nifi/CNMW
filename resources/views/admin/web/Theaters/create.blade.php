    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="TheaterCreateModalLabel">@lang('lang.create') @lang('lang.theater')</h1>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="name" class="form-label">@lang('lang.theater')</label>
                                <input class="form-control" id="name" type="text" name="name" placeholder="@lang('lang.type') @lang('lang.theater')">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="address" class="form-label">@lang('lang.address')</label>
                                <input class="form-control" id="address" type="text" name="address" placeholder="@lang('lang.type') @lang('lang.address')">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="location" type="text" name="location"
                                       placeholder="@lang('lang.type') @lang('lang.location')">
                            </div>
                        </div>
                    </div>
