                ...
                <form method="post" action="/admin/movie/edit/{!! $movie['id'] !!}" enctype="multipart/form-data">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <button type="submit" class="btn bg-gradient-primary btn-sm ms-auto">@lang('lang.confirm')</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <p class="text-uppercase text-sm">@lang('lang.edit') {!! $movie['name'] !!}</p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="movieName" class="form-control-label">@lang('lang.movie_name')</label>
                                    <input class="form-control" name="name" id="movieName" type="text" value="{!! $movie['name'] !!}" placeholder="@lang('lang.type') @lang('lang.movie_name')">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="movieGenres" class="form-label">@lang('lang.genre')</label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="rating" class="form-label">@lang('lang.rating')</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group file-uploader">
                                    ...
                                    @if(strstr($movie->image,"https") === false)
                                        <img class="img-fluid rounded-start img_movie" style="height: 315px" src="https://res.cloudinary.com/{!! $cloud_name !!}/image/upload/{{ $movie->image }}.jpg" alt="">
                                        @else
                                        <img class="img-fluid rounded-start" style="height: 315px" src="{{ $movie->image }}" alt="">
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="editor" class="form-label">@lang('lang.content')</label>
                                    <textarea class="form-control" name="description" id="editor"
                                              placeholder="@lang('lang.description')">{!! $movie['description'] !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        $(document).ready( function(){
            var selectedNational = "{{ $movie['national'] }}";
