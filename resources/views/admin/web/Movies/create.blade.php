        ...
        <div class="col-md-12">
            <div class="card">
                <form method="post" action="/admin/movie/create" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <h5 class="text-uppercase text-sm">@lang('lang.add')</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="movieGenres">@lang('lang.genre')</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="releaseDate"  id="releaseDate" class="form-control datepicker" placeholder="@lang('lang.date')" type="text">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="endDate">@lang('lang.end_date')</label>
                                    <input id="endDate" name="endDate" class="form-control datepicker" placeholder="@lang('lang.date')" type="text">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
