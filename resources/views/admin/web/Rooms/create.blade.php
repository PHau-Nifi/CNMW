                   ...
                   <div class="row">
                       <div class="col-3">
                           <div class="form-group">
                               <label for="name" class="form-label">@lang('lang.room')</label>
                               <input class="form-control" id="name" type="text" name="name" placeholder="@lang('lang.type') @lang('lang.room')">
                           </div>
                       </div>
                       <div class="col-3">
                           <div class="form-group">
                               ...
                               <input class="form-control" id="row" type="number" name="row" min="0" max="24"
                                      placeholder="@lang('lang.type') @lang('lang.row_number')">
                           </div>
                       </div>
                       <div class="col-3">
                           <div class="form-group">
                               ...
                               <input class="form-control" id="col" type="number" name="col" min="0" max="50"
                                      placeholder="@lang('lang.type') @lang('lang.col_number')">
                           </div>
                       </div>
                       <div class="col-3">
                           <div class="form-group">
